<script lang="ts">
	...
	import { translatePianoNotes } from '$lib/piano-translator';
	...
	$: if (autoPreviewEnabled) {
		outputNotes = inputNotes.trim() ? translatePianoNotes(inputNotes, { showSolfege }) : '';
	}

	function translateNotes(): void {
		autoPreviewEnabled = true;
		outputNotes = translatePianoNotes(inputNotes, { showSolfege });
	}
	...
	async function copyOutput(): Promise<void> {
		...
		try {
			...
			// Clipboard API fallback for browsers with restricted permissions.
